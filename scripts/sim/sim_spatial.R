...
n_indiv_per_group <- 30
n_groups <- 5
buckets <- 2 ## Set to 1 for annual model. Greater than 1 gives subannual (eg. buckets = 2 is infection period every half year)
...
par_tab[par_tab$names %in% c("alpha","beta"),"values"] <- c(1/3,1/3)#unlist(beta_pars)
