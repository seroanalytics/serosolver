...
write.table(titreDat,"~/net/home/serosolver/data_LSA/sim_measurement_independent_1000_dat.csv",row.names=FALSE,sep=",")
write.table(infHist,"~/net/home/serosolver/data_LSA/sim_measurement_independent_1000_infHist.csv",row.names=FALSE,sep=",")
write.table(ages,"~/net/home/serosolver/data_LSA/sim_measurement_independent_1000_ages.csv",row.names=FALSE,sep=",")
write.table(AR,"~/net/home/serosolver/data_LSA/sim_measurement_independent_1000_AR.csv",row.names=FALSE,sep=",")
