...
# stratification workflow as a manual reference and excluded it from the automated test suite.
# Set SEROSOLVER_RUN_LONG_TESTS=true to execute it manually.
if (!identical(Sys.getenv("SEROSOLVER_RUN_LONG_TESTS"), "true")) {
  testthat::skip("Long-running stratification reference workflow")
}
