...
antigenic_map <- setup_antigenic_map(antigenic_map,  n_biomarker_groups=2,unique_biomarker_groups=1:2)[[1]]
...
tmp <- add_rhos_par_tab(example_par_tab, 1:10, 2)
...
chains <- load_mcmc_chains(getwd(),example_par_tab,burnin=10000,estimated_only = FALSE)
