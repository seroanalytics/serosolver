...
test_that("Infection model returns expected values for titre dependent boosting", {
  ...
  correct_titre_dependent <- c(
    0, 0.0201010126776668, 0.585786437626905, 1.15147186257614,
    1.97123636456396, 2.44567705678503, 2.37074562459877, 2.73859200819185,
    2.15755700734281, 2.12210641876533, 1.64766572654427, 0.951581393960449,
    0.973322888846043, 0.995064383731636, 1.45958369439657, 1.45958369439657,
    0.994831893331855, 0.966547622084393, 0.938263350836931, 1.3737258300203,
    1.3737258300203, 0.921177490060914, 0.468629150101524, 0.0160808101421335
  )
