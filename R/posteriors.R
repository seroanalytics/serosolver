...
#' @param measurement_bias if not NULL, then use these indices to specify which measurement bias parameter index corresponds to which time. See the [advanced features vignette](https://seroanalytics.github.io/serosolver/articles/advanced_features.html) for this optional workflow.
...
#' @param fixed_inf_hists optional data frame with columns `individual`, `time`, and `value`, giving infection states that should be fixed during the MCMC run. See the [advanced features vignette](https://seroanalytics.github.io/serosolver/articles/advanced_features.html) for this optional workflow.
