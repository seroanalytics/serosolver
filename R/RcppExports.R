...
multiple_infection_strain_dependent <- function(predicted_titres, theta, cumu_infection_history, infection_map_indices, measurement_map_indices, antigenic_map_long, antigenic_map_short, waning, number_strains, additional_arguments) {
    invisible(.Call('_serosolver_multiple_infection_strain_dependent', PACKAGE = 'serosolver', predicted_titres, theta, cumu_infection_history, infection_map_indices, measurement_map_indices, antigenic_map_long, antigenic_map_short, waning, number_strains, additional_arguments))
}

multiple_infection_base_boosting <- function(predicted_titres, theta, cumu_infection_history, infection_map_indices, measurement_map_indices, antigenic_map_long, antigenic_map_short, waning, seniority, number_strains, n_samples, max_infections) {
    invisible(.Call('_serosolver_multiple_infection_base_boosting', PACKAGE = 'serosolver', predicted_titres, theta, cumu_infection_history, infection_map_indices, measurement_map_indices, antigenic_map_long, antigenic_map_short, waning, seniority, number_strains, n_samples, max_infections))
}
