...
plot_model_fits(chain = chain,infection_histories = inf_chain,example_antibody_data = antibody_data,individuals=c(1:4),antigenic_map=example_antigenic_map,par_tab=par_tab,orientation="cross-sectional")
