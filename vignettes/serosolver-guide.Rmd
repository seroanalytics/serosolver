...
<!-- Modified by an AI assistant on 2026-09-15 using GPT-5. Updated the guide's MCMC cache handling so missing cached chains trigger the hidden fitting workflow; no functional package code was changed. -->
...
mcmc_dir <- file.path("inst", "extdata", "guide")
