...
The function is passed to `serosolver(prior_func = prior_func)`. If a parameter is stratified, include every generated coefficient row in the prior function; this is illustrated in the [demographic variables and covariates vignette](DEMOGRAPHICS_VIGNETTE_LINK).
