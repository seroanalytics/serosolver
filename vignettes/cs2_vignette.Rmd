...
<!-- Modified by an AI assistant on 2026-09-16 using GPT-5. Reworked the
student case study into a package vignette, retaining the scientific text and
code comments while adding package-relative inputs, cached MCMC workflows,
and simulation-recovery checks. -->
...
sim_fit_par_tab <- simulated_data$par_tab %>% filter(par_type != 4)
