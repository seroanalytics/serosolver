...
res <- serosolver(example_par_tab, antibody_data, antigenic_map=antigenic_map,
                filename=mcmc_file, n_chains=2,parallel=FALSE,
                mcmc_pars=mcmc_pars,
                verbose=FALSE)

## Look at model fits to the data
res$plot_fits_cross_sectional
```
