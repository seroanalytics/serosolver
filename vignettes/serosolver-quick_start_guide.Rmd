...
output:
  ...
  rmarkdown::md_document # - need for GitHub rmarkdown::html_vignette #': default
csl: plos.csl
bibliography: vignette_references.bib
vignette: |
  %\VignetteIndexEntry{Serosolver Quick Start Guide} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
