...
```{r, eval=FALSE}
   mcmc_pars <- c("iterations"=50000,"popt"=0.44,"popt_hist"=0.44,"opt_freq"=1000,"thin"=1,
                 "adaptive_period"=10000, "save_block"=1000, "thin2"=10, "hist_sample_prob"=0.5,
                 "switch_sample"=2, "burnin"=0, "inf_propn"=0.5, "move_size"=5, "hist_opt"=1,
                 "swap_propn"=0.5,"hist_switch_prob"=0.5,"year_swap_propn"=0.5)
