...
<!-- Modified by an AI assistant on 2026-09-17 using GPT-5. Shortened the
vignette to the key variable terminology, added the terminology figure, and
linked to the published serosolver notation for comparison. -->
...
The figure below gives the corresponding mathematical notation and includes
some additional model quantities. It is useful when comparing the current
package interface with the notation used in the [published version of
`serosolver`](https://doi.org/10.1371/journal.pcbi.1007840), where some names
