...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type exponential_waning(exponential_waningSEXP);
...
Rcpp::NumericVector antibody_model_individual_wrapper(const double& boost_long, const double& boost_short, const double& boost_delay, const double& wane_short, const double& wane_long, const double& wane_maternal, const double& antigenic_seniority, const int& birth, const NumericVector& start_antibody_levels, const int number_possible_exposures, const NumericVector& possible_exposure_times, const IntegerVector& exposure_indices, const IntegerVector& biomarker_id_indices, const NumericVector& sample_times, const arma::mat& antigenic_map_long, const arma::mat& antigenic_map_short, const bool exponential_waning);
RcppExport SEXP _serosolver_antibody_model_individual_wrapper(SEXP boost_longSEXP, SEXP boost_shortSEXP, SEXP boost_delaySEXP, SEXP wane_shortSEXP, SEXP wane_longSEXP, SEXP wane_maternalSEXP, SEXP antigenic_senioritySEXP, SEXP birthSEXP, SEXP start_antibody_levelsSEXP, SEXP number_possible_exposuresSEXP, SEXP possible_exposure_timesSEXP, SEXP exposure_indicesSEXP, SEXP biomarker_id_indicesSEXP, SEXP sample_timesSEXP, SEXP antigenic_map_longSEXP, SEXP antigenic_map_shortSEXP, SEXP exponential_waningSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    Rcpp::traits::input_parameter< const double& >::type wane_maternal(wane_maternalSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type exponential_waning(exponential_waningSEXP);
...
NumericVector create_cross_reactivity_vector(NumericVector x, double cr_gradient, bool exponential_waning);
RcppExport SEXP _serosolver_create_cross_reactivity_vector(SEXP xSEXP, SEXP cr_gradientSEXP, SEXP exponential_waningSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type exponential_waning(exponential_waningSEXP);
    rcpp_result_gen = Rcpp::wrap(create_cross_reactivity_vector(x, cr_gradient, exponential_waning));
    return rcpp_result_gen;
END_RCPP
}
// sum_buckets
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(inf_hist_prop_prior_v2_and_v4(theta, unique_theta_indices, unique_biomarker_groups, indiv_group_indices, infection_history_mat, infection_history_mat_indices, likelihoods_pre_proposal, sampled_indivs, n_times_samp_vec, age_mask, sample_mask, n_alive, n_infections, n_infected_group, prior_lookup, proposal_inf_hist_indiv_swap_ratio, swap_distance, propose_from_prior, shape1, shape2, possible_exposure_times, possible_exposure_times_indices, sample_times, type_data_start, biomarker_groups, sample_data_start, antibody_data_start, nrows_per_sample, cum_nrows_per_individual_in_data, cum_nrows_per_individual_in_repeat_data, popn_group_id_vec, biomarker_id_indices, start_level_indices, starting_antibody_levels, births, antigenic_map_long, antigenic_map_short, antigenic_distances, antibody_data, antibody_data_repeats, n_measurements_total, repeat_indices, repeat_data_exist, measurement_shifts, proposal_iter, accepted_iter, proposal_swap, accepted_swap, overall_swap_proposals, overall_add_proposals, time_sample_probs, total_alive, data_types, obs_weights, indiv_possible_exposure_times_indices, indiv_poss_exp_times_start, indiv_poss_exp_times_end, exponential_waning, timevarying_groups, temp, solve_likelihood));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_serosolver_antibody_model", (DL_FUNC) &_serosolver_antibody_model, 24},
    {"_serosolver_antibody_model_individual_wrapper", (DL_FUNC) &_serosolver_antibody_model_individual_wrapper, 17},
    ...
    {"_serosolver_create_cross_reactivity_vector", (DL_FUNC) &_serosolver_create_cross_reactivity_vector, 3},
    ...
    {"_serosolver_inf_hist_prop_prior_v2_and_v4", (DL_FUNC) &_serosolver_inf_hist_prop_prior_v2_and_v4, 61},
    {NULL, NULL, 0}
};
