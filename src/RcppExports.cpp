...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_serosolver_inf_hist_prop_prior_v2_and_v4", (DL_FUNC) &_serosolver_inf_hist_prop_prior_v2_and_v4, 57},
    {NULL, NULL, 0}
};
