...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_serosolver_antibody_model_individual_wrapper", (DL_FUNC) &_serosolver_antibody_model_individual_wrapper, 16},
