...
static const R_CallMethodDef CallEntries[] = {
    {"_serosolver_antibody_model", (DL_FUNC) &_serosolver_antibody_model, 27},
    ...
    {"_serosolver_inf_hist_prop_prior_v2_and_v4", (DL_FUNC) &_serosolver_inf_hist_prop_prior_v2_and_v4, 64},
    {NULL, NULL, 0}
};
